...
from .PLucla import Netlist
from .PLucla import Node
from .PLucla import Net
from .PLucla import Pin
from .PLGeometricLib import Point
from .PLGridSpec import Grid
from .PLGridSpec import Row
from .PLLocationConversion import PlaneLocation, BinLocation, Bin2Plane
from .PLLocationConversion import GridLocation, Grid2Plane
from .PLLocationConversion import ThreeDLocation, ThreeD2Plane
...
class Sim_to_ucla(object):
    ...
    def create_sclFile(self, output_filename, num_rows=None, num_sites=None):
        self.g1.create_sclFile(
            output_filename,
            num_rows or config.import_num_rows,
            num_sites or config.import_num_sites
        )
        self.numRows = self.g1.numRows
        self.total_sites = self.g1.total_sites
        self.avg_sites_per_row = self.g1.avg_sites_per_row
